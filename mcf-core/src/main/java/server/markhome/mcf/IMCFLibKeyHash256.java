 ...
 * @author msobkow
 */
public interface IYCFLibKeyHash256 extends JSObject {
	...
	public default int compare(IYCFLibKeyHash256 h1, IYCFLibKeyHash256 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public IYCFLibKeyHash256 deepClone();
  ...
  public static boolean isNull(IYCFLibKeyHash256 anId) {
