...
/**
 * YCFLibReqKeyHash160 extends YCFLibKeyHash160 with the appropriate behavior for the isNull() and setNull() method signatures.
 *
 * @author msobkow
 */
public class YCFLibReqKeyHash160 extends YCFLibKeyHash160 implements IYCFLibRequired, IYCFLibReqKeyHash160 {
