 ...
 * @author msobkow
 */
public interface IYCFLibKeyHash384 extends JSObject {
	...
	public default int compare(IYCFLibKeyHash384 h1, IYCFLibKeyHash384 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public IYCFLibKeyHash384 deepClone();
  ...
  public static boolean isNull(IYCFLibKeyHash384 anId) {
