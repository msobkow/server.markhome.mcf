...
int PosixDirectives() {
    ...
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:LOCK_EX:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(LOCK_EX)));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:LOCK_EX:PropertyInfo:signedness=$%s$\n", ((LOCK_EX>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:LOCK_EX:PropertyInfo:value=%lX\n", ((unsigned long)LOCK_EX));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:LOCK_NB:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(LOCK_NB)));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:LOCK_NB:PropertyInfo:signedness=$%s$\n", ((LOCK_NB>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:LOCK_NB:PropertyInfo:value=%lX\n", ((unsigned long)LOCK_NB));
    ...
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:MREMAP_FIXED:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(MREMAP_FIXED)));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:MREMAP_FIXED:PropertyInfo:signedness=$%s$\n", ((MREMAP_FIXED>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:MREMAP_FIXED:PropertyInfo:value=%lX\n", ((unsigned long)MREMAP_FIXED));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:MREMAP_MAYMOVE:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(MREMAP_MAYMOVE)));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:MREMAP_MAYMOVE:PropertyInfo:signedness=$%s$\n", ((MREMAP_MAYMOVE>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:MREMAP_MAYMOVE:PropertyInfo:value=%lX\n", ((unsigned long)MREMAP_MAYMOVE));
    ...
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:SIGEV_SIGNAL:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(SIGEV_SIGNAL)));
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:SIGEV_SIGNAL:PropertyInfo:signedness=$%s$\n", ((SIGEV_SIGNAL>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:PosixDirectives:ConstantInfo:SIGEV_SIGNAL:PropertyInfo:value=%lX\n", ((unsigned long)SIGEV_SIGNAL));
    ...
    printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(int)));
    {
        unsigned long all_bits_set = -1;
        int enumHolder = all_bits_set;
        int is_unsigned = enumHolder > 0;
        printf("NativeCodeInfo:PosixDirectives:EnumInfo:int:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    ...
    printf("NativeCodeInfo:PosixDirectives:PointerToInfo:Lmid_t:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(Lmid_t)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        Lmid_t fieldHolder = all_bits_set;
        is_unsigned = fieldHolder > 0;
        printf("NativeCodeInfo:PosixDirectives:PointerToInfo:Lmid_t:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    ...
    printf("NativeCodeInfo:PosixDirectives:PointerToInfo:pthread_key_t:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(pthread_key_t)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        pthread_key_t fieldHolder = all_bits_set;
        is_unsigned = fieldHolder > 0;
        printf("NativeCodeInfo:PosixDirectives:PointerToInfo:pthread_key_t:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    ...
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_itimerspec:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(struct itimerspec)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_itimerspec:StructFieldInfo:it_interval:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct itimerspec *) 0)->it_interval)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_itimerspec:StructFieldInfo:it_interval:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct itimerspec, it_interval)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_itimerspec:StructFieldInfo:it_value:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct itimerspec *) 0)->it_value)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_itimerspec:StructFieldInfo:it_value:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct itimerspec, it_value)));
    ...
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_passwd:StructFieldInfo:pw_gid:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct passwd *) 0)->pw_gid)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_passwd:StructFieldInfo:pw_gid:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct passwd, pw_gid)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct passwd fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.pw_gid = all_bits_set;
        is_unsigned = fieldHolder.pw_gid > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_passwd:StructFieldInfo:pw_gid:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    ...
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(struct sigevent)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:StructFieldInfo:sigev_notify:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct sigevent *) 0)->sigev_notify)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:StructFieldInfo:sigev_notify:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct sigevent, sigev_notify)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct sigevent fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.sigev_notify = all_bits_set;
        is_unsigned = fieldHolder.sigev_notify > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:StructFieldInfo:sigev_notify:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:StructFieldInfo:sigev_signo:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct sigevent *) 0)->sigev_signo)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:StructFieldInfo:sigev_signo:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct sigevent, sigev_signo)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct sigevent fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.sigev_signo = all_bits_set;
        is_unsigned = fieldHolder.sigev_signo > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_sigevent:StructFieldInfo:sigev_signo:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    ...
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_hour:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct tm *) 0)->tm_hour)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_hour:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct tm, tm_hour)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct tm fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.tm_hour = all_bits_set;
        is_unsigned = fieldHolder.tm_hour > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_hour:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_mday:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct tm *) 0)->tm_mday)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_mday:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct tm, tm_mday)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct tm fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.tm_mday = all_bits_set;
        is_unsigned = fieldHolder.tm_mday > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_mday:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_min:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct tm *) 0)->tm_min)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_min:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct tm, tm_min)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct tm fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.tm_min = all_bits_set;
        is_unsigned = fieldHolder.tm_min > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_min:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_mon:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct tm *) 0)->tm_mon)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_mon:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct tm, tm_mon)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct tm fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.tm_mon = all_bits_set;
        is_unsigned = fieldHolder.tm_mon > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_mon:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_sec:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct tm *) 0)->tm_sec)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_sec:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct tm, tm_sec)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct tm fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.tm_sec = all_bits_set;
        is_unsigned = fieldHolder.tm_sec > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_sec:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_year:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((struct tm *) 0)->tm_year)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_year:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(struct tm, tm_year)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        struct tm fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.tm_year = all_bits_set;
        is_unsigned = fieldHolder.tm_year > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:struct_tm:StructFieldInfo:tm_year:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    ...
    printf("NativeCodeInfo:PosixDirectives:StructInfo:timer_t:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(timer_t)));
