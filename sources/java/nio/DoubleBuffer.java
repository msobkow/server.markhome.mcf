 ...
 *   single doubles; </p></li>
 *
 *   <li><p> Absolute and relative {@link #get(double[]) <i>bulk get</i>}
 *   methods that transfer contiguous sequences of doubles from this buffer
 *   into an array;</p></li>
 *
 *   <li><p> Absolute and relative {@link #put(double[]) <i>bulk put</i>}
 ...
 * on a {@linkplain java.nio.Buffer#isReadOnly read-only} DoubleBuffer. The
 * methods {@linkplain #array array} and {@linkplain #arrayOffset arrayOffset}
 * throw an {@linkplain UnsupportedOperationException} if the DoubleBuffer is
 * not backed by an {@linkplain Buffer#hasArray accessible double array}
...
public abstract sealed class DoubleBuffer
    ...
    HeapDoubleBuffer, DirectDoubleBufferS, DirectDoubleBufferU,
...

{
    ...
    DoubleBuffer(int mark, int pos, int lim, int cap,   // package-private
                 double[] hb, int offset, MemorySegment segment)
    {
    ...
    //
    DoubleBuffer(int mark, int pos, int lim, int cap, MemorySegment segment) { // package-private
        this(mark, pos, lim, cap, null, 0, segment);
    }

    // Creates a new buffer with given base, address and capacity
    //
    DoubleBuffer(double[] hb, long addr, int cap, MemorySegment segment) { // package-private
     ...
     *
     * <p> This method transfers {@code length} doubles from this
            ...
            try {
                ...
                if (order() != ByteOrder.nativeOrder())
                    SCOPED_MEMORY_ACCESS.copySwapMemory(
                            ...
                            dst, dstOffset, len, Double.BYTES);
                else
     ...
     *
     * <p> This method transfers {@code length} doubles into this buffer from
     ...
     * Absolute bulk <i>put</i> method&nbsp;&nbsp;<i>(optional operation)</i>.
     *
     * <p> This method transfers {@code length} doubles from the given
    ...
    AbstractMemorySegmentImpl heapSegment(Object base,
        ...
        return SegmentFactories.arrayOfDoubleSegment(base, offset, length, readOnly, bufferScope);
    }
