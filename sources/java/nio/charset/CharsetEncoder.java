...
public abstract class CharsetEncoder {
     ...
     *          {@code MalformedInputException} if the character sequence starting at the
     ...
     *          {@code UnmappableCharacterException} if the character sequence starting at
    ...
    public final ByteBuffer encode(CharBuffer in)
        throws CharacterCodingException
    {
        int n = Math.min((int)(in.remaining() * averageBytesPerChar()),
