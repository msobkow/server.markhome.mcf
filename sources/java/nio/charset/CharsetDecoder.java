...
public abstract class CharsetDecoder {
     ...
     *          {@code MalformedInputException} if the byte sequence starting at the
     ...
     *          {@code UnmappableCharacterException} if the byte sequence starting at
    ...
    public final CharBuffer decode(ByteBuffer in)
        throws CharacterCodingException
    {
        int n = Math.min((int)(in.remaining() * averageCharsPerByte()),
