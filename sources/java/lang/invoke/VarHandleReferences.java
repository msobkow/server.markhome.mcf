...
final class VarHandleReferences {
    ...
    static sealed class FieldStaticReadOnly extends VarHandle {
        ...
        FieldStaticReadOnly(Class<?> declaringClass, Object base, long fieldOffset, Class<?> fieldType) {
            this(declaringClass, base, fieldOffset, fieldType, FieldStaticReadOnly.FORM, false);
        }

        protected FieldStaticReadOnly(Class<?> declaringClass, Object base, long fieldOffset, Class<?> fieldType,
                                      VarForm form, boolean exact) {
            super(form, exact);
        ...
        public FieldStaticReadOnly withInvokeExactBehavior() {
            return hasInvokeExactBehavior()
                ? this
                : new FieldStaticReadOnly(declaringClass, base, fieldOffset, fieldType, vform, true);
        }
        ...
        public FieldStaticReadOnly withInvokeBehavior() {
            return !hasInvokeExactBehavior()
                ? this
                : new FieldStaticReadOnly(declaringClass, base, fieldOffset, fieldType, vform, false);
        }
    ...
    static final class FieldStaticReadWrite extends FieldStaticReadOnly {
        ...
        FieldStaticReadWrite(Class<?> declaringClass, Object base, long fieldOffset, Class<?> fieldType) {
            this(declaringClass, base, fieldOffset, fieldType, false);
        }

        private FieldStaticReadWrite(Class<?> declaringClass, Object base, long fieldOffset, Class<?> fieldType,
                                     boolean exact) {
            super(declaringClass, base, fieldOffset, fieldType, FieldStaticReadWrite.FORM, exact);
        }
        ...
        public FieldStaticReadWrite withInvokeExactBehavior() {
            return hasInvokeExactBehavior()
                ? this
                : new FieldStaticReadWrite(declaringClass, base, fieldOffset, fieldType, true);
        }
        ...
        public FieldStaticReadWrite withInvokeBehavior() {
            return !hasInvokeExactBehavior()
                ? this
                : new FieldStaticReadWrite(declaringClass, base, fieldOffset, fieldType, false);
        }
