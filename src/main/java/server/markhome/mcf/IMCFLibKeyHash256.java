 ...
 * @author msobkow
 */
public interface IMCFLibKeyHash256 extends JSObject {
	...
	public default int compare(IMCFLibKeyHash256 h1, IMCFLibKeyHash256 h2) {
		if (h1 == null) {
			if (h2 == null) {
				return 0;
			} else {
	...
	public IMCFLibKeyHash256 deepClone();
  ...
  public static boolean isNull(IMCFLibKeyHash256 anId) {
